# This is a fork of the original react-native-chart-kit library. The original library can be found [here](https://github.com/indiespirit/react-native-chart-kit)
