...
import { G, Rect, type RectProps, Svg, Text } from 'react-native-svg';

import AbstractChart from '../abstract-chart';
import { mapValue } from '../utils';
import { convertToDate, getBeginningTimeForDate, shiftDate } from './date-helpers';
import { DAYS_IN_WEEK, MILLISECONDS_IN_ONE_DAY, MONTH_LABELS } from './constants';
import type { ContributionGraphProps, ContributionGraphState } from '.';
...
class ContributionGraph extends AbstractChart<ContributionGraphProps, ContributionGraphState> {
	constructor(props: ContributionGraphProps) {
		...
		const { maxValue, minValue, valueCache } = this.getValueCache(props.values);
	...
	UNSAFE_componentWillReceiveProps(nextProps: ContributionGraphProps) {
		const { maxValue, minValue, valueCache } = this.getValueCache(nextProps.values);
