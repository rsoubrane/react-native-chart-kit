...
import type { ChartConfig, Dataset, PartialBy } from './helper-types';
...
> {
	...
	renderDefs = (
		...
		const fillShadowGradientFrom = config.hasOwnProperty('fillShadowGradientFrom') ? config.fillShadowGradientFrom : fillShadowGradient;
		...
		const fillShadowGradientToOpacity = config.hasOwnProperty('fillShadowGradientToOpacity') ? config.fillShadowGradientToOpacity : 0.1;

		const fillShadowGradientToOffset = config.hasOwnProperty('fillShadowGradientToOffset') ? config.fillShadowGradientToOffset : 1;
		...
		return (
			<Defs>
				...
				{useShadowColorFromDataset ? (
					...
					<LinearGradient id="fillShadowGradientFrom" x1={0} y1={0} x2={0} y2={height} gradientUnits="userSpaceOnUse">
						<Stop
							offset={fillShadowGradientFromOffset}
